                    ...
                    <div key={rental.id}
                        ...
                        <div className="p-5">
                            ...
                            <section className="flex justify-between mb-3">
                                <p className="text-lg text-gray-900 dark:text-white">{rental.caracteristic.nb_bedroom} chambres </p>
                                <p className="text-lg text-gray-900 dark:text-white">{rental.nb_person} pers.</p>
                                <p className="text-lg text-gray-900 dark:text-white">{rental.price}€/nuit</p>
                            </section>
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{rental.type}</p>
                            <a href="#"
